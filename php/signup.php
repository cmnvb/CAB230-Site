<?php
//Sign up page for Brisbane parks. The purpose of this page is to display the html for the form as well as connect to the 'validate sign up form.
			...
			<div id="wrapper">
				<div id="crumb">
					...
					<form id="registration-form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
						...
						<?php
							//input for username as well as prefilling if there is an error
							...
							//input for email that prefills the form if there is an issue
							...
							//input for children, must be an integer. prefills if theres an error.
							...
							//input for suburb, prefills. also connects to database to access the suburb list
							...
							echo '</select>'
						?>
						<!-- input for password does not prefill as this is standard practise.-->
